 ...
 *
 * Compiler:
 *   C: /mnt/common/hxu40/spack/opt/spack/linux-skylake_avx512/openmpi-5.0.9-ruzpfypjebiwjl5mcpko7uvqjnxkiwrd/bin/mpicc
 *     Id: GNU 11.4.0
 *   CXX: /mnt/common/hxu40/spack/opt/spack/linux-skylake_avx512/openmpi-5.0.9-ruzpfypjebiwjl5mcpko7uvqjnxkiwrd/bin/mpicxx
 *     Id: GNU 11.4.0
 *   Fortran: /mnt/common/hxu40/spack/opt/spack/linux-skylake_avx512/openmpi-5.0.9-ruzpfypjebiwjl5mcpko7uvqjnxkiwrd/bin/mpicxx
 *     Id: GNU 11.4.0
 */
...
#define ADIOS2_HAVE_DERIVED_VARIABLE
...
#define ADIOS2_FEATURE_LIST "BP3" "BP4" "BP5" "MHS","SST","FORTRAN","MPI","BLOSC2","MGARD","PNG","SZ","ZFP","O_DIRECT","CATALYST","SYSVSHMEM","UCX","PROFILING","DERIVED_VARIABLE","OPENSSL","XROOTD","CAMPAIGN",nullptr
